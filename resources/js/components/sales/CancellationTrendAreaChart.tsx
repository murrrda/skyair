...
function plural(n: number): string {
    return n === 1 ? 'otkazivanje' : 'otkazivanja';
}
    ...
    return (
        <div className="rounded-lg border border-border bg-popover px-3 py-2 text-sm shadow-md">
            ...
            <p className="text-muted-foreground">
                {b.count} {plural(b.count)}
            </p>
        </div>
    );
}

export default function CancellationTrendAreaChart({ data }: Props) {
    if (data.length === 0 || data.every((r) => r.count === 0)) {
        return (
            <p className="py-12 text-center text-sm text-muted-foreground">
                Nema otkazivanja za izabrani period.
            </p>
        );
    }
        ...
        <>
            ...
            <ResponsiveContainer width="100%" height={280}>
                <AreaChart
                    ...
                    aria-label="Area grafikon: trend otkazivanja"
                >
                    <defs>
                        <linearGradient
                            id="cancellationTrendFill"
                            x1="0"
                            y1="0"
                            x2="0"
                            y2="1"
                    ...
                    <Area
                        ...
                        stroke="#ef4444"
                        strokeWidth={2}
                        fill="url(#cancellationTrendFill)"
            ...
            <table className="sr-only">
                <caption>Trend otkazivanja</caption>
                <thead>
                    <tr>
                        <th>Period</th>
